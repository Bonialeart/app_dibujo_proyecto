...
template <> constexpr inline auto ProjectModel::qt_create_metaobjectdata<qt_meta_tag_ZN12ProjectModelE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<ProjectModel, qt_meta_tag_ZN12ProjectModelE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject ProjectModel::staticMetaObject = { {
    QMetaObject::SuperData::link<QAbstractListModel::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN12ProjectModelE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN12ProjectModelE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN12ProjectModelE_t>.metaTypes,
    nullptr
} };
...
void *ProjectModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN12ProjectModelE_t>.strings))
